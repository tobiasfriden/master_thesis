...
This is a non-linear optimization problem with linear constraints. In this work, it was solved using the \acs{ipopt} solver \cite{ipopt}, which is implemented in the \textabbr{casadi} toolkit, a general toolkit for solving nonlinear optimization problems numerically \cite{casadi}.
